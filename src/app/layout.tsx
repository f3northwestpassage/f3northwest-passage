...
export const metadata: Metadata = {
  ...
  description:
    "Join F3 Northwest Passage for free, peer-led outdoor fitness workouts for men in Cypress, Houston, and Northwest Houston, TX. No membership fees. Rain or shine. All fitness levels welcome.",
  keywords: [
    "F3",
    "F3 Northwest",
