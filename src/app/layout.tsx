...
export const metadata: Metadata = {
  ...
  description:
    'Join F3 Northwest Passage for free, peer-led outdoor fitness workouts for men in Cypress, Jersey Village, Bridgeland, Hockley, and Northwest Houston, TX. No membership fees. Rain or shine. All fitness levels welcome.',
  keywords: [
    'F3',
    'F3 Northwest',
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body
        className={`${inter.className} ${inter.variable} bg-white dark:bg-iron text-black dark:text-white font-sans text-lg text-center justify-center`}
      >
