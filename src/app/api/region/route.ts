...
export async function PUT(request: Request) {
  try {
    ...
    if (!password || password !== ADMIN_PASSWORD) {
      console.warn(
        'Unauthorized PUT /api/region attempt - Invalid or missing password'
      );
    ...
    const response = NextResponse.json(
      {
        message: error.message || 'Internal Server Error during region update.',
      },
      { status: 500 }
    );
    return setCorsHeaders(response);
...
export async function GET(request: NextRequest) {
  try {
      ...
      response = NextResponse.json(
        {
          ...
          meta_description:
            'This is a mock region configuration for demonstration or when no actual config exists.',
          ...
          region_map_embed_link:
            'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3463.5878401314945!2d-95.36980288488812!3d29.758938781989635!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640c1a7d653a92b%3A0x6b4f7a7d4a0b3e5b!2sHouston%2C%20TX!5e0!3m2!1sen!2sus!4v1678901234567!5m2!1sen!2sus', // Example embed link
          region_google_form_url:
            'https://docs.google.com/forms/d/e/1FAIpQLScqiwlrlx4n8WhK8VokVF-XGWXBbDhmLkgpZSeunbHy52dFHQ/viewform', // Example form URL
          region_fng_form_url:
            'https://docs.google.com/forms/d/e/1FAIpQLScqiwlrlx4n8WhK8VokVF-XGWXBbDhmLkgpZSeunbHy52dFHQ/viewform', // Example FNG form URL
        },
        { status: 404 }
      ); // Indicate that resource was not found, but providing a default
    } else {
    ...
    const response = NextResponse.json(
      {
        message: error.message || 'Internal Server Error during region fetch.',
      },
      { status: 500 }
    );
    return setCorsHeaders(response);
