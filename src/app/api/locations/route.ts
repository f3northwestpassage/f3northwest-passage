...
import { locationSchema, locationUpdateSchema } from '@/lib/validations';
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { message: 'Success: Location created.', location: created.toObject() },
      { status: 201 }
    );
  } catch (error: any) {
...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (!updated) {
      return NextResponse.json(
        { message: 'Error: Location not found for update.' },
        { status: 404 }
      );
    }

    return NextResponse.json(
      { message: 'Success: Location updated.', location: updated },
      { status: 200 }
    );
  } catch (error: any) {
...
export async function DELETE(request: NextRequest) {
  ...
  try {
    ...
    if (!locationId) {
      return NextResponse.json(
        { message: 'Error: Location ID required.' },
        { status: 400 }
      );
    }
    ...
    return NextResponse.json(
      { message: 'Success: Location and workouts deleted.' },
      { status: 200 }
    );
  } catch (error: any) {
    if (session) {
