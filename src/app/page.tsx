...
export async function generateMetadata(): Promise<Metadata> {
  ...
  try {
    ...
    console.error(
      'Error fetching locale data for metadata on home page:',
      error
    );
  ...
  return (
    <>
      ...
      <main className="bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 min-h-screen">
        ...
        {fetchError ? (
          <section
            className="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded dark:bg-red-800 dark:border-red-600 dark:text-red-100 my-8 max-w-4xl mx-auto"
            role="alert"
          >
          ...
          <>
            <section
              className={`bg-gloom dark:bg-gray-900 text-black dark:text-gray-200 ${commonSliceClassNames}`}
            >
              <div className="shadow-xl">
                <h2 className="leading-none">
                  <span className="opacity-70">
                    FREE OUTDOOR WORKOUTS IN{' '}
                    {localeData?.region_city?.toUpperCase() || 'HOUSTON'}
                  </span>
                  <span className="block text-5xl py-5">
                    {localeData?.region_name ?? ''}
                  </span>
                </h2>
            ...
            <section
              className={`bg-iron dark:text-white dark:bg-gray-800 text-black ${commonSliceClassNames}`}
            >
              <div>
              ...
              <div>
                ...
                <p className="font-bold pb-6">
                  plant, grow and serve small workout groups for men,
                  invigorating male community leadership.
                </p>
              </div>
            </section>
            ...
            <section className="bg-gloom dark:bg-gray-900 text-black dark:text-gray-200 leading-tight pt-20 px-4 pb-24">
              ...
              <p className="text-cmu text-md pb-10">
                ...
                requirement for membership other than showing up at the
                appointed time + place and following the workout leader (the “Q”
                in F3 lexicon). If you still have questions, just ask any of the
                guys and
